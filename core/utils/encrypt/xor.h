...
#define _( s ) s
#else
#define __( s ) jm::make_xorstr([]() { return s; }, std::make_index_sequence<sizeof( s ) / sizeof( *s )>{}, std::make_index_sequence<jm::detail::_buffer_size<sizeof( s )>()>{})
#define _( s ) __( s ).crypt_get()
#endif
