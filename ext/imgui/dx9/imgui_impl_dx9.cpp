...
void ImGui_ImplDX9_RenderDrawData(ImDrawData* draw_data)
{
    ...
    if (bd->pd3dDevice->CreateStateBlock( /*D3DSBT_ALL*/ D3DSBT_PIXELSTATE, &d3d9_state_block ) < 0)
        return;
    ...
    bd->pd3dDevice->GetVertexDeclaration( &vertex_declaration );
    bd->pd3dDevice->GetVertexShader( &vertex_shader );
    ...
    bd->pd3dDevice->SetVertexDeclaration( vertex_declaration );
    bd->pd3dDevice->SetVertexShader( vertex_shader );
