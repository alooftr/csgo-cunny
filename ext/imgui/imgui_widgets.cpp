...
// For 32-bit and larger types, slider bounds are limited to half the natural type range.SliderScalar
...
#include "../../core/utils/console_log.h"
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    if (!(flags & ImGuiColorEditFlags_NoSmallPreview))
    {
        ...
        //static float copy_col[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
        //OpenPopupOnItemClick( "copypaste", ImGuiPopupFlags_MouseButtonRight );
        //if ( BeginPopup( "copypaste" ) )
        //{
...
namespace ImGui
{
    ...
    static float            TabBarCalcMaxTabWidth(int tabs);
...
static float ImGui::TabBarCalcMaxTabWidth( int tabs )
{
    ImGuiContext& g = *GImGui;
    return (GetContentRegionAvail( ).x / tabs) - g.Style.FramePadding.x /*g.FontSize * 20.0f;*/;
}
